...
def criar_tabela(cursor):
    cursor.execute("""
    CREATE OR REPLACE TABLE tb_stg_dnbr (
        ORIGEM STRING,
        CODESTAB STRING,
        CODMUNNASC STRING,
        LOCNASC STRING,
...
def main():
    ...
    ftp_path = '/dissemin/publicos/SINASC/1996_/Dados/DNRES/DNBR2022.dbc'

    tmp_dir = tempfile.mkdtemp()
    local_dbc = os.path.join(tmp_dir, 'DNBR2022.dbc')
    local_csv = os.path.join(tmp_dir, 'DNBR2022.csv')

    print(f"Arquivo CSV será salvo em: {local_csv}")
